...
const (
	AuditLogTypesEmailCreated                         AuditLogTypes = "email_created"
	AuditLogTypesEmailDeleted                         AuditLogTypes = "email_deleted"
	AuditLogTypesEmailVerified                        AuditLogTypes = "email_verified"
	AuditLogTypesLoginFailure                         AuditLogTypes = "login_failure"
	AuditLogTypesLoginSuccess                         AuditLogTypes = "login_success"
	AuditLogTypesOtpCreated                           AuditLogTypes = "otp_created"
	...
	AuditLogTypesPasskeyCreated                       AuditLogTypes = "passkey_created"
	AuditLogTypesPasskeyDeleted                       AuditLogTypes = "passkey_deleted"
	AuditLogTypesPasswordChanged                      AuditLogTypes = "password_changed"
	AuditLogTypesPasswordDeleted                      AuditLogTypes = "password_deleted"
	...
	AuditLogTypesPrimaryEmailChanged                  AuditLogTypes = "primary_email_changed"
	AuditLogTypesSecurityKeyCreated                   AuditLogTypes = "security_key_created"
	AuditLogTypesThirdpartyLinkingSucceeded           AuditLogTypes = "thirdparty_linking_succeeded"
	AuditLogTypesThirdpartySigninSignupFailed         AuditLogTypes = "thirdparty_signin_signup_failed"
	...
	AuditLogTypesTokenExchangeFailed                  AuditLogTypes = "token_exchange_failed"
	AuditLogTypesTokenExchangeSucceeded               AuditLogTypes = "token_exchange_succeeded"
	AuditLogTypesUserCreated                          AuditLogTypes = "user_created"
	AuditLogTypesUserDeleted                          AuditLogTypes = "user_deleted"
	AuditLogTypesUserLoggedOut                        AuditLogTypes = "user_logged_out"
	AuditLogTypesUsernameChanged                      AuditLogTypes = "username_changed"
	AuditLogTypesUsernameDeleted                      AuditLogTypes = "username_deleted"
	...
	AuditLogTypesWebauthnCredentialDeleted            AuditLogTypes = "webauthn_credential_deleted"
	AuditLogTypesWebauthnCredentialUpdated            AuditLogTypes = "webauthn_credential_updated"
...
// PatchUser Patch payload for updating a user.
//
// Omitted properties are not changed.
type PatchUser struct {
	// FamilyName Set a new family name for the user.
	//
	// Send `null` to remove the family_name.
	FamilyName *string `json:"family_name"`

	// GivenName Set a new given name for the user.
	//
	// Send `null` to remove the given_name.
	GivenName *string `json:"given_name"`

	// Name Set a new username for the user.
	//
	// Send `null` to remove the name.
	Name *string `json:"name"`

	// Picture Set a new picture for the user. Must be a public URL accessible
	// via HTTP/HTTPS. Must not contain credentials.
	//
	// Send `null` to remove the picture.
	Picture *string `json:"picture"`

	// Username Set a new username for the user.
	//
...
type ClientInterface interface {
	...
	PatchUserWithBody(ctx context.Context, id UUID4, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PatchUser(ctx context.Context, id UUID4, body PatchUserJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PatchUserWithBody(ctx context.Context, id UUID4, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) PatchUser(ctx context.Context, id UUID4, body PatchUserJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewPatchUserRequest(server string, id UUID4, body PatchUserJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
...
func NewPatchUserRequestWithBody(server string, id UUID4, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	PatchUserWithBodyWithResponse(ctx context.Context, id UUID4, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PatchUserResponse, error)

	PatchUserWithResponse(ctx context.Context, id UUID4, body PatchUserJSONRequestBody, reqEditors ...RequestEditorFn) (*PatchUserResponse, error)
...
func (c *ClientWithResponses) PatchUserWithBodyWithResponse(ctx context.Context, id UUID4, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PatchUserResponse, error) {
...
func (c *ClientWithResponses) PatchUserWithResponse(ctx context.Context, id UUID4, body PatchUserJSONRequestBody, reqEditors ...RequestEditorFn) (*PatchUserResponse, error) {
